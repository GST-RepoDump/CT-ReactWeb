...
//Clevertap Github reference: https://github.com/CleverTap/clevertap-web-sdk

function App() {

  const pageLoadEvent = () => {
    clevertap.event.push("PageLoad");
      console.log("PageLoad event triggred");
  }
...
<body>
        ...
        <button onClick={pageLoadEvent}>PageLoad event</button>
    </body>
